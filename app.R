...
packages <- c(
  "DBI", "odbc", "shiny", "shinyjs", "tidyverse", "lubridate", "DT", "naniar", "shinyWidgets", "magrittr", "xts", "shinyTime",
...
if (userlocation == "Wachusett") { ### WACHUSETT ####
  ...
  server <- function(input, output, session) {
    ...
    callModule(HOBO, "mod_hobos",
      hobo_path = hobo_path, updir = updir, hobo_db = hobo_db, df_trib_monitoring = df_trib_monitoring,
    ...
    callModule(MF_CORRECT, "mod_mayfly_correct",
      df_fp = df_fp,
  ...
  df_trib_monitoring <- df_trib_monitoring %>%
    ...
    mutate(
      DateTimeUTC = with_tz(force_tz(DateTimeUTC, tzone = "America/New_York"), tzone = "UTC"),
